...
namespace CompanyName.MyMeetings.Modules.Registrations.ArchTests.Application
{
    [TestFixture]
    public class ApplicationTests : global::CompanyName.MyMeetings.ArchTests.SeedWork.ApplicationArchTestsBase
    {
        protected override Assembly ApplicationAssembly => typeof(IRegistrationsModule).Assembly;
